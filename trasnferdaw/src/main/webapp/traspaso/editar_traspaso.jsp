    ...
    <div class="row">
        ...
        <section class="col-md-9">
            ...
            <form action="TraspasoController" method="POST" class="row g-3">
                ...
                <input type="hidden" name="jugadorId" value="<%= traspaso.getNombreJugador() %>" />
                <input type="hidden" name="equipoOrigenId" value="<%= traspaso.getNombreEquipoOrigen() %>" />
                <input type="hidden" name="equipoDestinoId" value="<%= traspaso.getNombreEquipoDestino() %>" />
                <input type="hidden" name="temporadaId" value="<%= traspaso.getNombreTemporada() %>" />
                ...
                <div class="col-md-6">
                    <label for="equipo_origen" class="form-label">Equipo Origen</label>
                    <input type="text" class="form-control" value="<%= traspaso.getNombreEquipoOrigen() %>" disabled>
                </div>

                <div class="col-md-6">
                    <label for="equipoDestino" class="form-label">Equipo Destino</label>

        ...
        <section class="col-md-9" id="content">
            <% if (esAdmin) { %>
                <div class="alert alert-success" role="alert">
                    Bienvenido, <%= nombreUsuario %>. Eres administrador. ¡Tienes el control total del sistema!
                </div>
            <% } else if (nombreUsuario != null) { %>
                <div class="alert alert-info" role="alert">
                    Bienvenido, <%= nombreUsuario %>. Estás navegando como lector. Solo puedes visualizar la información.
                </div>
            <% } %>
            ...
            <article class="mb-4">
                ...
                <% if (esAdmin) { %>
                    <p>Como eres administrador ¡Tú tienes el control, inserta, modifica, elimina, busca un valor de mercado de un jugador en concreto o visualízalos todos!</p>
                <% } else { %>
